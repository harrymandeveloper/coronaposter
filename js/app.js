((d) => {
  ...
  const secondInstruction = [
    ...
    "Lose the <br /> remote down the back of the sofa",
    "Have a nice cold pint",
    "Open six <br /> packets of crisps<br /> <div class='triangle'></div><br /> Have all of the crisps ",
    "Have a cup of tea",
    "Accidentally hit unmute while farting during a pub quiz",
    "Discover <br /> mysterious island",
    "Assemble <br /> Robot Army",
    "Have a biscuit",
    "Open Tik Tok Account",
    "Trash talk <br /> Carole Baskin",
    "Tell Child \'That\'s Amazing\'",
    "Chair <br /> a meeting in your pyjamas",
    "Find flux capacitor",
    "Find sports almanac",
